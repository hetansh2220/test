      ...
      <div className="w-full max-w-sm lg:max-w-4xl lg:flex lg:items-center lg:gap-16 animate-scale-in">
        ...
        <div className="hidden lg:flex lg:flex-col lg:flex-1 lg:pr-8">
          <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6">
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary to-savings opacity-20 blur-xl" />
            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-savings flex items-center justify-center">
